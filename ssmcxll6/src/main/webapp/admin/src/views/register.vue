  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">大学生就业平台微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='qiye'">
			...
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.tongyishehuixinyongdaima" class="input" type="text" placeholder="统一社会信用代码">
			   </div>
			 </div> -->
			<el-form-item label="统一社会信用代码" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.tongyishehuixinyongdaima" autocomplete="off" placeholder="统一社会信用代码"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			   <div class="label">法人姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.farenxingming" class="input" type="text" placeholder="法人姓名">
			   </div>
			 </div> -->
			<el-form-item label="法人姓名" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.farenxingming" autocomplete="off" placeholder="法人姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='qiye'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='qiye'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='qiye'" class="input-group">
			   <div class="label">邮箱</div>
