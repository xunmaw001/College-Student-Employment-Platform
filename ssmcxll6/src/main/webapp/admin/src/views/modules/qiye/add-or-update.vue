<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="统一社会信用代码" prop="tongyishehuixinyongdaima">
          <el-input v-model="ruleForm.tongyishehuixinyongdaima" 
              placeholder="统一社会信用代码" clearable  :readonly="ro.tongyishehuixinyongdaima"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="统一社会信用代码" prop="tongyishehuixinyongdaima">
              <el-input v-model="ruleForm.tongyishehuixinyongdaima" 
                placeholder="统一社会信用代码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yingyezhizhao" label="营业执照" prop="yingyezhizhao">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yingyezhizhao.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="法人姓名" prop="farenxingming">
          <el-input v-model="ruleForm.farenxingming" 
              placeholder="法人姓名" clearable  :readonly="ro.farenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="法人姓名" prop="farenxingming">
              <el-input v-model="ruleForm.farenxingming" 
                placeholder="法人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yingyezhizhao = true;
          ...
          if(o=='farenxingming'){
            this.ruleForm.farenxingming = obj[o];
	    this.ro.farenxingming = true;
            continue;
          }
          if(o=='shenfenzheng'){
