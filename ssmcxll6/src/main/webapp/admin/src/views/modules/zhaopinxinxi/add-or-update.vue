<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="企业类型" prop="qiyeleixing">
          <el-select v-model="ruleForm.qiyeleixing" placeholder="请选择企业类型">
            <el-option
                v-for="(item,index) in qiyeleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
