<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="毕业学校" prop="biyexuexiao">
          <el-input v-model="ruleForm.biyexuexiao" 
              placeholder="毕业学校" clearable  :readonly="ro.biyexuexiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="毕业学校" prop="biyexuexiao">
              <el-input v-model="ruleForm.biyexuexiao" 
                placeholder="毕业学校" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="期望薪资" prop="qiwangxinzi">
          <el-input v-model="ruleForm.qiwangxinzi" 
              placeholder="期望薪资" clearable  :readonly="ro.qiwangxinzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="期望薪资" prop="qiwangxinzi">
              <el-input v-model="ruleForm.qiwangxinzi" 
                placeholder="期望薪资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="期望行业" prop="qiwangxingye">
          <el-input v-model="ruleForm.qiwangxingye" 
              placeholder="期望行业" clearable  :readonly="ro.qiwangxingye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="期望行业" prop="qiwangxingye">
              <el-input v-model="ruleForm.qiwangxingye" 
                placeholder="期望行业" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="期望岗位" prop="qiwanggangwei">
          <el-input v-model="ruleForm.qiwanggangwei" 
              placeholder="期望岗位" clearable  :readonly="ro.qiwanggangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="期望岗位" prop="qiwanggangwei">
              <el-input v-model="ruleForm.qiwanggangwei" 
                placeholder="期望岗位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiwangxinzi = true;
          ...
          if(o=='qiwangxingye'){
            this.ruleForm.qiwangxingye = obj[o];
	    this.ro.qiwangxingye = true;
            continue;
          }
          if(o=='qiwanggangwei'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `mianshiyaoqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.mianshiyaoqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
