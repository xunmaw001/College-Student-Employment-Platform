	...
	<view class="content">
		<view @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}" :style='{"backgroundColor":"rgba(102, 102, 153, 1)","height":"200rpx"}'>
												...
												<view v-if="tableName=='xuesheng'" class="userinfo">
																																																																<view class="info">
															<view class="username" :style='{"boxShadow":"0 0 16rpx rgba(255,255,255,0)","backgroundColor":"rgba(0,0,0,0)","borderColor":"rgba(255,255,255,.3)","borderRadius":"8rpx","color":"rgba(255, 255, 204, 1)","textAlign":"left","borderWidth":"0","width":"240rpx","lineHeight":"36rpx","fontSize":"24rpx","borderStyle":"solid"}'>{{user.xueshengzhanghao}}</view>
																																																																										</view>
			</view>
																		<view v-if="tableName=='qiye'" class="userinfo">
																																																																																<view class="info">
		...
		<view class="list">
			...
			<view v-for="item in menuList" v-bind:key="item.roleName">
				...
				<view class="text" :style='{"color":"#333","fontSize":"28rpx"}'>用户反馈</view>
