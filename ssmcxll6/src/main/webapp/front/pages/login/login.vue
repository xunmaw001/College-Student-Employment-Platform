<template>
	<view class="content">
		...
		<view class="links">
            			            <view class="link-highlight" @tap="onRegisterTap('xuesheng')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册学生</view>
            <view>|</view>
                        			            <view class="link-highlight" @tap="onRegisterTap('qiye')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册企业</view>
            <view>|</view>
