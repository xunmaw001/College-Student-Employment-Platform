...
public class QiyeController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		QiyeEntity user = qiyeService.selectOne(new EntityWrapper<QiyeEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody QiyeEntity qiye){
    	...
    	QiyeEntity user = qiyeService.selectOne(new EntityWrapper<QiyeEntity>().eq("zhanghao", qiye.getZhanghao()));
		if(user!=null) {
